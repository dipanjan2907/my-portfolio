      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            <span className="border-b-4 border-indigo-600 pb-2">
              Get In Touch
            </span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            {/* <form className="space-y-6" onSubmit={submitHandler}>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-gradient-to-r from-red-600 to-indigo-600  to-orange-600 text-white rounded-lg font-medium hover:opacity-90 transition-opacity flex items-center justify-center space-x-2"
              >
